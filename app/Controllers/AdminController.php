...
{
    private $admin, $session, $usuarios, $clientes, $prestamos, $vehiculos, $fabricantes, $modelos, $cajas;
    ...
    public function dashboard()
    {
        ...
        $data['vehiculos'] = $this->vehiculos->where('estado', '1')->countAllResults();
        $data['fabricantes'] = $this->vehiculos->where('estado', '1')->countAllResults();
        $data['modelos'] = $this->vehiculos->where('estado', '1')->countAllResults();
