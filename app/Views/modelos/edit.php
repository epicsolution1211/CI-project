        ...
        <form action="<?php echo base_url('modelos'); ?>" method="post" autocomplete="off">
            ...
            <div class="row">
                <div class="form-group col-lg-4">
                    ...
                    <select name="id_fabricante" class="form-control">
                        <?php while($row2 = mysqli_fetch_array($result1)):;?>
                            <option <?php if ($modelo['id_fabricante'] == $row2[1] ) echo 'selected="selected"'?> ><?php echo $row2[1];?></option>    
                        <?php endwhile;?>          
                    </select>
                ...
                <div class="form-group col-lg-4">
                    ...
                    <input type="text" minlength="3" name="nombre_modelo" class="form-control" value="<?php echo set_value('nombre_modelo', $modelo['nombre_modelo']); ?>" placeholder="Nombre Modelo" required>
