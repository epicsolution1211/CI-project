...
<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            if (
                verificar('nuevo vehiculo', $_SESSION['permisos'])
                || verificar('listar vehiculos', $_SESSION['permisos'])
            ) { ?>
                <li class="dropdown <?php echo ($active == 'vehiculo') ? 'active' : ''; ?>">
                    <a href="#" class="menu-toggle nav-link has-dropdown">
                        <i class="fa fa-car mx-1"></i>
                        <span>Vehiculos</span></a>
                    <ul class="dropdown-menu">
                        <?php if (verificar('nuevo vehiculo', $_SESSION['permisos'])) { ?>
                            <li><a class="nav-link" href="<?php echo base_url('fabricantes'); ?>">Fabricantes</a></li>
                        <?php }

                        /* if (verificar('nuevo vehiculo', $_SESSION['permisos'])) { ?>
                             <li><a class="nav-link" href="<?php echo base_url('modelos'); ?>">Modelos</a></li>
                         <?php } */

                        if (verificar('listar vehiculos', $_SESSION['permisos'])) { ?>
                            <li><a class="nav-link" href="<?php echo base_url('vehiculos'); ?>">Inventario</a></li>
                        <?php } ?>
