                        ...
                        <div class="align-items-center justify-content-between">
                            <div class="row ">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                                    <div class="banner-img icon-dashboard">
                    ...
                    <div class="card-statistic-4">
                        <div class="align-items-center justify-content-between">
                            <div class="row ">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                    <div class="card-content">
                                        <h5 class="font-15">Financiamientos</h5>
                    ...
                    <div class="card-statistic-4">
                        <div class="align-items-center justify-content-between">
                            <div class="row ">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                    <div class="card-content">
                                        <h5 class="font-15">Vehículos</h5>
                                        <h2 class="mb-3 font-18"><?php echo $vehiculos; ?></h2>
                                        <a class="mb-0" href="<?php echo base_url('vehiculos'); ?>">VER DETALLE</a>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                                    <div class="banner-img icon-dashboard">
                                        <img src="<?php echo base_url('assets/img/admin/vehiculo.png'); ?>" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
