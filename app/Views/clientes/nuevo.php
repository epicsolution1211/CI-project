        ...
        <form action="<?php echo base_url('clientes'); ?>" method="post" autocomplete="off">
            ...
            <div class="row">
                <div class="form-group col-lg-4">
                    ...
                    <input type="text" name="identidad" class="form-control" value="<?php echo set_value('identidad'); ?>" placeholder="INE/Pasaporte">
                ...
                <div class="form-group col-lg-4">
                    <label>N° OCR</label>
                    <input type="text" maxlength="13" name="num_identidad" class="form-control" value="<?php echo set_value('num_identidad'); ?>" placeholder="N° OCR">
