        ...
        columns: [
            {
                ...
                render: function (data, type) {
                    if (type === 'display') { 
                        return `<a class="btn btn-primary" href="${ base_url + 'modelos/' + data.id + '/edit' }"><i class="fas fa-edit"></i></a>
                        <form action="${ base_url + 'modelos/' + data.id }" method="post" class="d-inline eliminar">
